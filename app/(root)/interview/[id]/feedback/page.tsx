    ...
    <section className='section-feedback'>
      ...
      <div className='buttons'>
        <Button className="btn-secondary flex-1">
          <Link href="/" className='flex flex w-full justify-center'>
            <p className='text-sm font-semibold text-primary-200 text-center'>Back to DashBoard</p>
          </Link>
        </Button>
        {/* <Button className="btn-primary flex-1">
          <Link href={`/interview/${id}`} className='flex flex w-full justify-center'>
            <p className='text-sm font-semibold text-dark-200 text-center'>Retake Interview</p>
          </Link>
        </Button> */}
      </div>
    </section>
